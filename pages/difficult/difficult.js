...
Page({
    ...
    dd.getStorage({
      ...
      success:(res) => {
        ...
        // this.setData({arrayDep : [res.data.departments]}); 获取用户所在的部门
          // dd.httpRequest({
          //     url: app.globalData.serverUrl + '/check/getDifficultList',
          //     method: 'POST',
          //     headers: { 'Content-Type': 'application/x-www-form-urlencoded;charset=UTF-8' },
          //     dataType: 'json',
          //     success: resp => {
          //       console.log("res in getDifficultList")
          //       console.log(resp)
  ...
  onItemClick(ev) {
    ...
    console.log(ev);
    dd.navigateTo({
      url: '/pages/check/difficultItems/difficultItems?no='+ev.currentTarget.dataset.rpno
    })
  },
});
